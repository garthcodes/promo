...
user1.promotions.create!(start_date: '2018-04-01', end_date: '2018-04-15', discount: 2000,  user_message: 'You saved $20 for your loyalty', internal_message: 'fake internal message 20 assigned', code: '20-assigned', assigned: true)
user2.promotions.create!(start_date: '2018-04-15', end_date: '2018-04-25', discount: 3000,  user_message: 'You saved $30 for your loyalty', internal_message: 'fake internal message 30 assigned', code: '30-assigned', assigned: true)
